...
public class ProjectManagerController {
    ...
    private ProjectManager projectManager = new ProjectManager("John Doe", 35, "PM123", "123-456-7890");

    // Handle "View Projects" button click
    @FXML
    private void onViewProjects() {
        String projectStatus = projectManager.viewProjectCompletion();
    ...
    private void onReportEmployee() {
        ...
        String reportMessage = projectManager.reportEmployee(employeeName, reportDetails);
        reportStatusLabel.setText(reportMessage);
