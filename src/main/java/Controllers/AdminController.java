...
public class AdminController {
    ...
    public void initialize() {
        admin = new Admin("Admin", 35, "1", "admin123");
    ...
    private void addUser() {
        ...
        User newUser = new Admin(name, age, id, password); // Add as Admin for simplicity
    ...
    private void updateUser() {
        ...
        int age = Integer.parseInt(ageText);
        boolean updated = admin.updateUser(id, name, age, password);
        if (updated) {
            refreshTable();
            clearFields();
